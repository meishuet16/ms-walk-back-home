...
test("April 6 is registered as the authored 406 chapter", () => {
  ...
  assert.equal(april06Chapter.title, authoredContentExpectations.chapters.april06.display.title);
...
test("April 6 keeps the canonical closure factual and singular", () => {
  assert.deepEqual(april06Chapter.canonicalClosure.lines, authoredContentExpectations.chapters.april06.closure);

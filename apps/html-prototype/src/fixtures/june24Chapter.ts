...
export const june24Chapter: ChapterDefinition = {
  ...
  canonicalClosure: {
    ...
    lines: [ "那天下午，我们坐在同一张桌子前。",
    "后来聊到了 5 月 23 日，她才知道那天我其实真的来过。"]
  },
  reflectionQuotes: [
    { id: "june24-accepting", tone: "accepting", preference: { acceptance: 1, honesty: 1 }, lines: ["后来我终于知道，她真的以为我没有来。", "但 5 月 23 日还是 5 月 23 日。"],  afterline: "知道了。也不会把那一天重新过一遍。" },
...
export const june24EchoDialogues: Record<string, Array<{ speaker: string; text: string }>> = {
  "june24-angela-st-echo": [
    { speaker: "朋友", text: "诶你没有看到她吗\n她在楼下坐着诶\n你没有去找她吗" },
    { speaker: "我", text: "蛤\n我怎么会看到她" },
    { speaker: "朋友", text: "你现在眼里已经没有她了吗" },
    { speaker: "我", text: "啊对对对" },
    { speaker: "我", text: "。。。\n她现在在楼下？\n为啥 她在这里干嘛" },
    { speaker: "朋友", text: "好像在温习吧\n对 她就在这里楼下坐着\n你现在下去就可以看到她了" },
    { speaker: "我", text: "噢噢\n。。。\n科科" }
  ],
...
export function resolveJune24Actions(layout: SceneLayout, mode: "main" | "echo", echoId = ""): CutsceneAction[] {
  ...
  const actions: CutsceneAction[] = [
    ...
    { type: "dialogue", speaker: "她", text: "你怎么会在这里的\n你怎样知道我在这里\n你不用上课吗" },
    { type: "dialogue", speaker: "我", text: "我没有上课啊" },
    { type: "dialogue", speaker: "她", text: "骗人\n你朋友刚刚说你们有课" },
    { type: "dialogue", speaker: "我", text: "对啊我朋友上罢了" },
    { type: "dialogue", speaker: "她", text: "真的么" },
    { type: "dialogue", speaker: "我", text: "对啊我没有上课\n特地来这里只为了找你的" },
    { type: "dialogue", speaker: "她", text: "我信你个鬼" },
    { type: "dialogue", speaker: "她", text: "看下你脖子的伤口好点了吗 可怜的孩子。" },
    { type: "dialogue", speaker: "我", text: "唉 我现在不止脖子破洞\n钱包也破洞了 惨惨的。" },
    ...
    { type: "dialogue", speaker: "她", text: "哇你一大早就喝冰的饮料 够力" },
    { type: "dialogue", speaker: "我", text: "随便吧 生活已经不会更糟糕了" },
    { type: "dialogue", speaker: "她", text: "。。。" },
    { type: "dialogue", speaker: "她", text: "给你看这个 我的小八可爱吗" },
    { type: "dialogue", speaker: "我", text: "可爱啊 欸我有更可爱的\n等下我拿给你 嘿嘿" },
    { type: "dialogue", speaker: "她", text: "一定是很丑的\n我不要 你等下别再来了" },
    { type: "dialogue", speaker: "我", text: "谁理你 就来" },
    { type: "dialogue", speaker: "我", text: "哇塞这杯萝卜鲜奶有够难喝的，放这里先，我下课了再回来拿。" },
    ...
    { type: "dialogue", speaker: "我", text: "其实萝卜本身是好喝的 只是这杯太甜了 跟你一样嘻嘻" },
    { type: "dialogue", speaker: "她", text: "。。。。。。" },
    ...
    move(layout, "ms", "ms-second-seat", "left", 0.12, table("left", "01-sitting-opposite"), "left"),
    { type: "sprite", actor: "ms", sprite: table("left", "01-sitting-opposite"), visualScale: 0.3 },
    { type: "dialogue", speaker: "我", text: "欸 其实我5月23号那天真的去了" },
    ...
    { type: "dialogue", speaker: "她", text: "球球你不要再转那个五毛回来了\n等下欠人东西我心里总觉得不踏实" },
    { type: "dialogue", speaker: "我", text: "ok啊那我不要还你\n然后也继续讲你\n我不亏诶" },
    ...
    { type: "dialogue", speaker: "她", text: "嘿嘿，拜拜。" },

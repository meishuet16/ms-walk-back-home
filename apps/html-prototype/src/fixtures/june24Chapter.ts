...
export function resolveJune24Actions(layout: SceneLayout, mode: "main" | "echo", echoId = ""): CutsceneAction[] {
  ...
  const actions: CutsceneAction[] = [
    ...
    { type: "dialogue", speaker: "ET", text: "哈喽" },
    { type: "dialogue", speaker: "MS", text: "hi屁噢" },
    { type: "dialogue", speaker: "ET", text: "zomok你在这里的\n你怎样知道我在这里\n你不用上课吗" },
    { type: "dialogue", speaker: "MS", text: "我没有上课啊" },
    { type: "dialogue", speaker: "ET", text: "骗人\nangela讲你们上philosophy" },
    { type: "dialogue", speaker: "MS", text: "对啊angela上罢了" },
    { type: "dialogue", speaker: "ET", text: "真的么" },
    { type: "dialogue", speaker: "MS", text: "对啊我没有上课\n特地来这里只为了找你的" },
    { type: "dialogue", speaker: "MS", text: "我现在不止钱包破洞\n脖子也破洞" },
    ...
    { type: "dialogue", speaker: "ET", text: "哇你一大早就喝冰的 够力" },
    { type: "dialogue", speaker: "ET", text: "你看我的小八可爱吗" },
    { type: "dialogue", speaker: "MS", text: "可爱啊 欸我有更可爱的\n等下我拿给你 嘿嘿" },
    { type: "dialogue", speaker: "ET", text: "一定是很丑的\n我不要 你不要来了" },
    { type: "dialogue", speaker: "MS", text: "谁理你 就来" },
    { type: "dialogue", speaker: "ET", text: "walao你不要留这杯东西在这边\n等下我喝掉" },
    { type: "dialogue", speaker: "MS", text: "给你喝咯\n我不要了 很难喝\n等下要丢了" },
    { type: "dialogue", speaker: "ET", text: "walao难喝就给我啦" },
    ...
    { type: "dialogue", speaker: "ET", text: "哇老你喝什么东西来的\n够难喝哦\nteh tarik吗" },
    { type: "dialogue", speaker: "MS", text: "萝卜啊" },
    { type: "dialogue", speaker: "ET", text: "哇靠谁家好人喝萝卜" },
    ...
    { type: "dialogue", speaker: "ET", text: "你要一直坐在这里吗？你朋友几时来哦" },
    { type: "dialogue", speaker: "MS", text: "怎么？我就是想坐在这里看你读书啊\n你越不给我在这里\n我越要在这里" },
    ...
    move(layout, "ms", "ms-second-seat", "left", 0.12, table("left", "01-sitting-opposite"), "left"),
    { type: "sprite", actor: "ms", sprite: table("left", "01-sitting-opposite"), visualScale: 0.3 },
    { type: "dialogue", speaker: "MS", text: "其实我5月23号那天真的去了" },
    { type: "sprite", actor: "et", sprite: table("right", "03-surprised-5-23"), visualScale: 0.3 },
    { type: "dialogue", speaker: "ET", text: "真的吗\n你不要骗我" },
    { type: "dialogue", speaker: "MS", text: "真的啊" },
    { type: "dialogue", speaker: "ET", text: "我不信\n你一定是在车大炮" },
    ...
    { type: "dialogue", speaker: "MS", text: "包真的啊\n我还看到你的背影了" },
    ...
    { type: "dialogue", speaker: "ET", text: "ok我懂了不用翻相册了\n为什么你那时候不叫住我" },
    { type: "dialogue", speaker: "MS", text: "叫住你？\n怎样叫住你？" },
    { type: "wait", duration: 0.2 },
    { type: "dialogue", speaker: "MS", text: "为什么要叫住你？" },
    { type: "dialogue", speaker: "ET", text: "喊我名字\n然后过来跟我讲你真的来了啊" },
    { type: "dialogue", speaker: "MS", text: "可是我那他不是早就说过我到了吗" },
    { type: "dialogue", speaker: "ET", text: "呜呜呜呜\n对不起\n我以为你在车大炮" },
    { type: "dialogue", speaker: "MS", text: "我从来没有骗过你\n一直都是你在放我飞机" },
    { type: "checkpoint", id: "june24-reflection-1" },
    { type: "dialogue", speaker: "ET", text: "对不起" },
    { type: "dialogue", speaker: "MS", text: "对不起然后呢\n后续呢" },
    { type: "dialogue", speaker: "ET", text: "我真的没时间了\n这个礼拜final week\n下个礼拜study week\n后个礼拜就exam了" },
    { type: "dialogue", speaker: "MS", text: "呜呜呜 " },
    { type: "dialogue", speaker: "ET", text: "哎呀你干嘛 不要扮可怜勒\nok咯拜四我们去散步" },
    { type: "dialogue", speaker: "MS", text: "你看我信吗\n你走过来我宿舍咯" },
    { type: "dialogue", speaker: "ET", text: "看你信不信咯\n就是明天" },
    { type: "dialogue", speaker: "MS", text: "呵呵" },
    { type: "dialogue", speaker: "ET", text: "球球你不要转那个五毛回来了\n等下欠人东西我心里总觉得不踏实" },
    { type: "dialogue", speaker: "MS", text: "ok那我不要还你\n然后也继续讲你\n我不亏诶" },
    { type: "dialogue", speaker: "ET", text: "可以啊\n至少我知道我还了" },
    ...
    { type: "dialogue", speaker: "ET", text: "我很愧疚" },
    { type: "dialogue", speaker: "MS", text: "怎么了" },
    { type: "dialogue", speaker: "ET", text: "想到那天你来了\n可是我和别人走掉了" },
    ...
    { type: "dialogue", speaker: "MS", text: "我朋友来带我走了\n你开心了咯" },
    { type: "dialogue", speaker: "MS", text: "我靠你们琢磨偷拍我" },
    { type: "dialogue", speaker: "ET", text: "哇靠琢磨他们突然要拍你" },

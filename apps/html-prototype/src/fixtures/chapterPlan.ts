...
export type ForestDoor = { id: string; date: string; title: string; chapterId: string; x: number; y: number; };

export const bakeryChapter: HtmlChapterScene = {
  id: "bakery-day", diaryEntryId: "authored-diary-bakery-day", date: "07.28", title: "Yumido Bread", mood: "warm, unfinished", weather: "soft rain", location: "Bakery", characters: ["Friend A"], objects: ["pastry", "window", "door"], evidence: ["fictional-fixture-evidence"],
  dialogue: [
    { id: "friend-asks", speaker: "她", portrait:{ src: "assets/friend-a.png",height: 180 }, text: "你读完了那一天。奇怪吧，日记只写了几行，可人会在没写下来的地方长大。那天我不是真的要你解释，我只是想知道：如果一句话没有被接住，它会不会一辈子都在原地等。", choices: [
    ...
    { id: "what-now", speaker: "她", portrait:{ src: "assets/friend-a.png",height: 180 }, text: "桌上的甜面包还是那么小。回忆最残忍的地方不是它会变暗，是我们后来太会修饰它。你现在可以把它讲得漂亮一点，也可以让它继续难看。你想怎么记得我？", choices: [
    ...
    { id: "leave", speaker: "她", portrait:{ src: "assets/friend-a.png",height: 180 }, text: "如果我们都不能回到十几岁的身体里重新说话，那至少可以决定：以后想起这一天时，要让哪一种自己活下来。你要带哪一个自己离开？", choices: [
...
export const forestDoors: ForestDoor[] = [
  { id: "final-dream-tomorrow", date: "08.??", title: "Tomorrow", x: 0, y: 0, chapterId: "final-dream-tomorrow" },

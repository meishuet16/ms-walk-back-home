...
export const labisEchoes: LabisEcho[] = [
  ...
  { id: "july19-filter-evening", label: "说明书", prompt: "E · 回想说明书", presentation: "secondary-visual-echo", x: 1060, y: 430, radius: 150, tell: "paper", requires: ["july19-photo-threat"], repeatable: true },

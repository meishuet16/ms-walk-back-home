...
export const labisEchoes: LabisEcho[] = [
  { id: "july19-photo-threat", label: "照片", prompt: "E · 回想照片", presentation: "secondary-echo", x: 1040, y: 350, radius: 115, tell: "character", repeatable: true },
  ...
  { id: "july19-chicken-cake", label: "昨晚", prompt: "E · 回想昨晚", presentation: "hidden-keyframe", x: 435, y: 610, radius: 92, tell: "hidden-star", repeatable: true }
];

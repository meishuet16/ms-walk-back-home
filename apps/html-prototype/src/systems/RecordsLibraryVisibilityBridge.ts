...
// Developer-owned soundtrack records. These IDs are generated by MujiRoom's
// vinylRecordsFromAudioFiles() from the *actual repository filenames*.
// They stay playable through ChapterMusicBridge / FinalDreamBridge but never
// enter the player-facing Records catalogue.
export const developerHiddenRecordIds = new Set<string>([
  "audio-ringtone", // 張韶涵有形的翅膀伴奏Ringtone.mp3
  "audio-music", // 再见太难 / 我好想你 / 瞬 (same generated ID)
  "audio-track-255294", // 梁靜茹可惜不是你伴奏.mp3
  "audio-live", // 带我走live吴青峰.mp3
  "audio-xia-hu-those-bygone-years-na", // 胡夏 ... 那些年
  "audio-dear-d", // Dear D (亲爱的告诉你)
